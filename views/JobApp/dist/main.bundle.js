...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs__ = __webpack_require__(724);
...
var JobsService = (function () {
    ...
    JobsService.prototype.getJobs = function () {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["b" /* Headers */]();
        headers.append('Content-Type', 'application/json');
        return this._http.get('http://localhost:8080/jobs', { headers: headers }).map(function (res) { return res.json(); });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__jobs_jobs_module__ = __webpack_require__(555);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_forms__ = __webpack_require__(157);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_jobs__ = __webpack_require__(171);
...
var JobComponent = (function () {
    ...
    Object.defineProperty(JobComponent.prototype, "jobStatusText", {
        get: function () {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_jobs__ = __webpack_require__(171);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_single_job_single_job_component__ = __webpack_require__(552);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__filter_pipe__ = __webpack_require__(553);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__job_status_pipe__ = __webpack_require__(554);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__services_jobs__ = __webpack_require__(171);
...
var JobsModule = (function () {
    ...
    JobsModule = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["b" /* NgModule */])({
            ...
            exports: [__WEBPACK_IMPORTED_MODULE_4__components_jobs_jobs_component__["a" /* JobsComponent */], __WEBPACK_IMPORTED_MODULE_5__components_job_job_component__["a" /* JobComponent */], __WEBPACK_IMPORTED_MODULE_6__components_single_job_single_job_component__["a" /* SingleJobComponent */]]
        }), 
        __metadata('design:paramtypes', [])
    ], JobsModule);
    return JobsModule;
...
module.exports = "<div class=\"row\">\r\n  <div class=\"col-xs-12 col-lg-3 col-lg-push-9\">\r\n    <div id=\"right-nav\" class=\"thumbnail\">\r\n      <div class=\"inner caption row\">\r\n        <div class=\"col-lg-12 col-md-4 col-sm-5 col-xs-12\">\r\n          <a routerLink=\"/add-job\"\r\n             class=\"btn btn-primary add-job\">Add Job</a>\r\n          <h3>Job Tracker</h3>\r\n          <h4>Closest Deadline</h4>\r\n          <h4><span class=\"label label-success ng-binding\">23 Hrs 46 Mins Ago</span></h4>\r\n          <h4>Next Shipment</h4>\r\n          <h4><span class=\"label label-warning ng-binding\">2 Hrs 2 Mins Ago</span></h4>\r\n          <hr/>\r\n          <form action=\"\">\r\n            <div class=\"checkbox\">\r\n              <label [ngClass]=\"{'line-through': !displayStatus.machining}\">\r\n                <input type=\"checkbox\" [checked]=\"displayStatus.machining\" (change)=\"displayStatus.machining = !displayStatus.machining\" />\r\n                <span>Machining</span>\r\n              </label>\r\n            </div>\r\n            <div class=\"checkbox\">\r\n              <label [ngClass]=\"{'line-through': !displayStatus.quality}\">\r\n                <input type=\"checkbox\" [checked]=\"displayStatus.quality\" (change)=\"displayStatus.quality = !displayStatus.quality\" />\r\n                <span>Quality</span>\r\n              </label>\r\n            </div>\r\n            <div class=\"checkbox\">\r\n              <label [ngClass]=\"{'line-through': !displayStatus.staging}\">\r\n                <input type=\"checkbox\" [checked]=\"displayStatus.staging\" (change)=\"displayStatus.staging = !displayStatus.staging\" />\r\n                <span>Staging</span>\r\n              </label>\r\n            </div>\r\n            <div class=\"checkbox\">\r\n              <label [ngClass]=\"{'line-through': !displayStatus.waiting}\">\r\n                <input type=\"checkbox\" [checked]=\"displayStatus.waiting\" (change)=\"displayStatus.waiting = !displayStatus.waiting\" />\r\n                <span>Waiting</span>\r\n              </label>\r\n            </div>\r\n            <div class=\"checkbox\">\r\n              <label [ngClass]=\"{'line-through': !displayStatus.shipping}\">\r\n                <input type=\"checkbox\" [checked]=\"displayStatus.shipping\" (change)=\"displayStatus.shipping = !displayStatus.shipping\" />\r\n                <span>Shipping</span>\r\n              </label>\r\n            </div>\r\n          </form>\r\n        </div>\r\n        <div class=\"col-lg-12 col-md-8 col-sm-7 col-xs-12\">\r\n          <h3>Progress Tracker</h3>\r\n            <h5 class=\"ng-binding\">INT1 <span><!-- ngIf: name === 'QA1' --></span></h5>\r\n            <p class=\"alert alert-info\">No Deployment Running...</p>\r\n          </div><!-- end ngIf: !env -->\r\n          </div><!-- end ngIf: !env -->\r\n          </div>\r\n        </div>\r\n  <div class=\"col-xs-12 col-lg-9 col-lg-pull-3\">\r\n    <div class=\"row\" *ngIf=\"displayStatus.machining\">\r\n      <div class=\"col-md-12\">\r\n        <h3>\r\n          Machining\r\n        </h3>\r\n      </div>\r\n      <div class=\"col-md-4 job-wrapper machining\" *ngFor=\"let job of jobs | filter: 1\">\r\n        <job [job]=\"job\"></job>\r\n      </div>\r\n    </div>\r\n  </div>\r\n</div>\r\n\r\n<div class=\"row\" *ngIf=\"displayStatus.staging\">\r\n  <div class=\"col-md-12\">\r\n    <h3>Staging</h3>\r\n  </div>\r\n  <div class=\"col-xs-12 col-lg-3 col-lg-push-9\"></div>\r\n  <div class=\"col-xs-12 col-lg-9 col-lg-pull-3\">\r\n    <div class=\"row\">\r\n      <div class=\"col-md-4 job-wrapper staging\" *ngFor=\"let job of jobs | filter: 0\">\r\n        <job [job]=\"job\"></job>\r\n      </div>\r\n    </div>\r\n  </div>\r\n</div>\r\n\r\n<div class=\"row\" *ngIf=\"displayStatus.quality\">\r\n  <div class=\"col-md-12\">\r\n    <h3>Quality</h3>\r\n  </div>\r\n  <div class=\"col-xs-12 col-lg-3 col-lg-push-9\"></div>\r\n  <div class=\"col-xs-12 col-lg-9 col-lg-pull-3\">\r\n    <div class=\"row\">\r\n      <div class=\"col-md-4 job-wrapper quality\" *ngFor=\"let job of jobs | filter: 2\">\r\n        <job [job]=\"job\"></job>\r\n      </div>\r\n    </div>\r\n  </div>\r\n</div>\r\n\r\n<div class=\"row\" *ngIf=\"displayStatus.shipping\">\r\n  <div class=\"col-md-12\">\r\n    <h3>Shipping</h3>\r\n  </div>\r\n  <div class=\"col-xs-12 col-lg-3 col-lg-push-9\"></div>\r\n  <div class=\"col-xs-12 col-lg-9 col-lg-pull-3\">\r\n    <div class=\"row\">\r\n      <div class=\"col-md-4 job-wrapper shipping\" *ngFor=\"let job of jobs | filter: 3\">\r\n        <job [job]=\"job\"></job>\r\n      </div>\r\n    </div>\r\n  </div>\r\n</div>\r\n\r\n<div class=\"row\" *ngIf=\"displayStatus.waiting\">\r\n  <div class=\"col-md-12\">\r\n    <h3>Waiting</h3>\r\n  </div>\r\n  <div class=\"col-xs-12 col-lg-3 col-lg-push-9\"></div>\r\n  <div class=\"col-xs-12 col-lg-9 col-lg-pull-3\">\r\n    <div class=\"row\">\r\n      <div class=\"col-md-4 job-wrapper waiting\" *ngFor=\"let job of jobs | filter: 5\">\r\n        <job [job]=\"job\"></job>\r\n      </div>\r\n    </div>\r\n  </div>\r\n</div>\r\n\r\n\r\n\r\n\r\n"
